...
::: additional
OLED в варианте 1 является дополнительным каналом локальной индикации. Подключайте его к I2C Lichee с питанием 3,3 В; отсутствие OLED не должно нарушать SPI-приём и MQTT-публикацию.
:::
...
::: additional
C-сборщик в варианте 3 выполняется после готовой Python-версии. Для сравнения используйте одинаковый набор метрик и интервал публикации, отдельно зафиксируйте размер процесса, загрузку CPU и размер исполняемого файла.
:::
